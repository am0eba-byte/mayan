<html>
    ...
    <body>
         ...
         <h2>Stuff which Depicts <?php require_once("config.php"); echo htmlspecialchars($_GET["gname"])?></h2>
         
        <?php require_once("config.php");
        $godID = htmlspecialchars($_GET["godID"]);
        $contents = REST_PATH . "/db/mayan-queries/PHPgetStuffbyGods.xql?godID=$godID";
